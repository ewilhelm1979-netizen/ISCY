...
candidate="$(mutate_manifest migration_count_low '.migration_count = 39')"
expect_rejected migration_count_low "$candidate" "$source_snapshot" "$source_db_admin" "$source_notes" migration_count

candidate="$(mutate_manifest migration_count_high '.migration_count = 41')"
...
gap_manifest="$(mutate_manifest migration_gap '.migration_count = 39')"
