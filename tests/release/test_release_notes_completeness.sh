...
Tag und noch kein GitHub Release fuer V23.7.31. Aenderungen werden bis zur
...
sed 's/ISCY V23\.7\.31/ISCY V23.7.32/' "$development_notes" >"$wrong_development_version"
