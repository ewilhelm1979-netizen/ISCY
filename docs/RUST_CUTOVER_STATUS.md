...
- Alertmanager-Webhook: `/api/v1/operations/alertmanager` mit optionaler Incident-/Evidence-Persistenz bei schreibendem Tenant-Kontext; Monitoring-Beispiele nutzen den technischen Operations-User `ops-alertmanager`, Secret-Datei fuer Bearer Token und Alert-Incident-Metriken
