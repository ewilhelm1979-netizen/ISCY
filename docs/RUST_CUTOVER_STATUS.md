...
2. **Auth, Sessions und Admin:** Rust-Sessions und Passwort-Login sind vorhanden und werden in Web/API-Kontexten aufgeloest. Rollen-/Rechtepruefung, Admin-Funktionen und Berechtigungsoberflaechen sind noch nicht vollstaendig durch Rust ersetzt.
...
1. Rollen-/Rechtepruefung und Admin-/User-Management in Rust finalisieren.
