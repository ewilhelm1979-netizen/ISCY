...
- Alertmanager-Webhook: `/api/v1/operations/alertmanager` mit optionaler Incident-/Evidence-Persistenz bei schreibendem Tenant-Kontext; Monitoring-Beispiele koennen feste ISCY-Kontext-Header senden
