...
| Visual Regression | Candidate-Prüfung erforderlich | 40/40 Baselines, keine automatische Baseline-Aktualisierung. |
...
- [ ] MinIO-Lifecycle, Performance, HA und Visual Regression 40/40 sind grün.
