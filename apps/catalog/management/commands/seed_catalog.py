...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        maturity_questions = [
            ...
            ('CLOUD_IDENTITY', 'CLOUD', 'Sind Cloud-Admin-Rollen, Service Accounts und API-Schluessel nach Least-Privilege abgesichert?', 'Cloud-Kompromittierungen entstehen haeufig ueber ueberprivilegierte Identitaeten und Schluessel.', 'Cloud-IAM-Baseline mit Least-Privilege, Schluesselrotation und break-glass-Prozess umsetzen.', 'CRITICAL', 'MEDIUM', 'TECHNICAL', 'Phase 4 – Quick Wins', True, True),
            ...
            ('CYBER_WINDOWS_HARDENING', 'CYBER', 'Sind Windows-Server und Clients nach Baselines gehaertet (z. B. Defender, Firewall, SMB, Makros, lokale Adminrechte)?', 'Windows-Hardening reduziert gaengige Initial-Access- und Lateral-Movement-Pfade deutlich.', 'Windows-Hardening-Baseline definieren, per GPO/MDM ausrollen und regelmaessig pruefen.', 'HIGH', 'MEDIUM', 'TECHNICAL', 'Phase 4 – Quick Wins', True, True),
            ...
            ('OT_OPCUA_SCADA', 'OTSEC', 'Sind OPC-UA-, MES- und SCADA-Schnittstellen mit Authentisierung, Verschluesselung und Netzwerkgrenzen abgesichert?', 'Offene OT-Schnittstellen ohne Härtung erhoehen das Risiko fuer Manipulation und Produktionsausfall.', 'OT-Schnittstellen-Baseline fuer OPC UA/MES/SCADA definieren und ueberwachen.', 'CRITICAL', 'LARGE', 'TECHNICAL', 'Phase 5 – Strukturmassnahmen', False, False, False, False, True, False),
            ('OT_IDENTPRO_ACCESS', 'OTSEC', 'Sind Identitaeten fuer Produktionssysteme (z. B. IdentPro, Engineering-Workstations, Fernwartung) zentral gesteuert und protokolliert?', 'Unkontrollierte Identitaeten in der Produktion sind ein zentraler Angriffsvektor.', 'Zentrales IAM/PAM fuer Produktionszugriffe mit Sitzungstracking und Freigabeprozess umsetzen.', 'CRITICAL', 'LARGE', 'TECHNICAL', 'Phase 5 – Strukturmassnahmen', False, False, False, False, True, False),
