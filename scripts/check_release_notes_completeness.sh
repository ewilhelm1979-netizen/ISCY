...
case "$release_status" in
    development_unreleased)
        ...
        require_phrase predecessor "Basis: ${backtick}V23.7.30${backtick}" \
            'Die veroeffentlichte Basis V23.7.30 fehlt.'
    ...
    prepared_not_published)
        ...
        require_phrase predecessor "Vorgänger: ${backtick}V23.7.30${backtick}" \
            'Der veroeffentlichte Vorgaenger V23.7.30 fehlt.'
