...
REPORT_SNAPSHOT_BACKEND = os.getenv('REPORT_SNAPSHOT_BACKEND', 'rust_service')
DASHBOARD_SUMMARY_BACKEND = os.getenv('DASHBOARD_SUMMARY_BACKEND', 'rust_service')
CATALOG_BACKEND = os.getenv('CATALOG_BACKEND', 'rust_service')
REQUIREMENTS_BACKEND = os.getenv('REQUIREMENTS_BACKEND', 'rust_service')
ASSET_INVENTORY_BACKEND = os.getenv('ASSET_INVENTORY_BACKEND', 'rust_service')
PROCESS_REGISTER_BACKEND = os.getenv('PROCESS_REGISTER_BACKEND', 'rust_service')
RISK_REGISTER_BACKEND = os.getenv('RISK_REGISTER_BACKEND', 'rust_service')
EVIDENCE_REGISTER_BACKEND = os.getenv('EVIDENCE_REGISTER_BACKEND', 'rust_service')
ASSESSMENT_REGISTER_BACKEND = os.getenv('ASSESSMENT_REGISTER_BACKEND', 'rust_service')
ROADMAP_REGISTER_BACKEND = os.getenv('ROADMAP_REGISTER_BACKEND', 'rust_service')
WIZARD_RESULTS_BACKEND = os.getenv('WIZARD_RESULTS_BACKEND', 'rust_service')
IMPORT_CENTER_BACKEND = os.getenv('IMPORT_CENTER_BACKEND', 'rust_service')
PRODUCT_SECURITY_BACKEND = os.getenv('PRODUCT_SECURITY_BACKEND', 'rust_service')
